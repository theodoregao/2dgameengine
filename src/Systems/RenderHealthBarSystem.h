 ...
 public:
  ...
  void Update(SDL_Renderer* renderer,
    ...
    for (auto entity : GetSystemEntities()) {
      ...
      const auto sprit = entity.GetComponent<SpriteComponent>();
      ...
      double healthBarPosX =
          (transform.position.x + (sprit.width * transform.scale.x)) - camera.x;
      ...
      SDL_Surface* surface =
          TTF_RenderText_Blended(assetStore->GetFont("pico8-font-5"),
